...
var extractor = {
  ...
  extract: function extract(filename, localeDir) {
    ...
    (0, _babelCore.transformFileSync)(filename, (0, _extends3.default)({}, babelOptions, frameworkOptions, {
      plugins: [
      ...
      "macros", _babelPluginTransformJs2.default, _babelPluginTransformReact2.default, [_babelPluginExtractMessages2.default, { localeDir: localeDir }]].concat((0, _toConsumableArray3.default)(plugins))
    }));
  }
};
