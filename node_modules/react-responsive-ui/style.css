...
.rrui__date-picker .rrui__expandable__content {
  display: inline-block;
  padding-top: calc(var(--rrui-unit) * 2);
  padding-bottom: calc(var(--rrui-unit) * 2);
  padding-left: calc(var(--rrui-unit) * 2);
  padding-right: calc(var(--rrui-unit) * 2); }
...
.rrui__switch__input:focus + .rrui__switch__groove + .rrui__switch__knob {
  box-shadow: inset 0 0 0 0.03em var(--rrui-checkbox-color-checked), 0 0 0.05em var(--rrui-checkbox-color-checked), 0 0.1em 0.2em rgba(0, 0, 0, 0.2); }
